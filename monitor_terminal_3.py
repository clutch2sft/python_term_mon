...
class DeviceMonitor:
    ...
    def log_to_both(self, message, level=logging.INFO, console=True):
    ...
    def log_dot11_message(self):
        ...
        if self.last_dot11_message and self.dot11_message_count > 0:
            ...
            self.log_to_both(f"{self.last_dot11_message} has repeated {self.dot11_message_count} times", logging.INFO, console=False)
            self.dot11_message_count = 0
    ...
    def process_line(self, line):
        ...
        if match:
            ...
            self.log_to_both(line, logging.DEBUG)
